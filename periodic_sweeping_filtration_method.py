#==================================================================================
# Periodic Sweeping Plane Filtration Method
...
#
#   A script containing methods used to compute persistence homology of periodic
#   binary images using sweeping-plane filtrations in TDA, adapted from the codes
#   associated with the paper: J. T. Nardini, B. J. Stolz, K. B. Flores,
#   H. A. Harrington, and H. M. Byrne, 	Topological data analysis distinguishes
#   parameter regimes in the Anderson-Chaplain model of angiogenesis, PLOS Comput.
#   Biol., 17 (2021)
#==================================================================================
